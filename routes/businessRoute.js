...
router.route("/signup").post(businessSignup);
router.route("/login").post(businessLogin);
router.route("/forgetPasswordOTP").get(forgetPasswordOTP);
router.route("/forgetPassword").post(forgetPassword);
router.route("/businessDetails").get(businessDetails);
router.route("/businessDetailsID").get(businessDetailsByID);
router
  .route("/loggedInBusinessDetails")
  .get(verifyJWT, loggedInBusinessDetails);
router.route("/changePassword").post(verifyJWT, changePassword);
router.route("/owner").post(ownerOTPGeneration);
router.route("/details").get(verifyJWT, getInternshipDetails);
